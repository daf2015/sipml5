...
// Icons
import { Building2, Users, Phone, Plus, Trash2, Edit, QrCode, LogOut, Home, Copy, ExternalLink, Settings } from 'lucide-react';
...
const EdificioAdminDashboard = () => {
  ...
  const [showEditCantidad, setShowEditCantidad] = useState(false);
